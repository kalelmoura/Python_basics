...
def questions():
    ...
    for i in range(50):
        ...
        answer4 = state_capitals[number] # answer
        while answer1 == answer4 or answer2 == answer4 or answer3 == answer4 or answer1 == answer2 or answer2 == answer3 or answer3 == answer1:
                answer1 = state_capitals[random.randint(0,49)]
                answer2 = state_capitals[random.randint(0,49)]
                answer3 = state_capitals[random.randint(0,49)]
...
for i in range(35):
    ...
    testFile = open(f"/Users/gabrielkalel/programing/Python/Automate_Boring_stuff/quizFiles(chap10)/test{i+1}.txt", 'w')
    for key, value in test.items():
        testFile.write(key + '\n' + value + '\n')
    testFile.close()
    answersFile = open(f"/Users/gabrielkalel/programing/Python/Automate_Boring_stuff/quizFiles(chap10)/testAnswers{i+1}.txt", 'w')
